...
<body>
    <div class="register-container">
        ...
        <form method="POST" action="<?php echo e(url('/register')); ?>">
            ...
            <div class="form-group">
                <label for="role"><?php echo e($labels['user_role'] ?? 'دور المستخدم'); ?></label>
                <div class="input-group">
                    <i class="fas fa-user-tag left"></i>
                    <select id="role" name="role" required>
                        <option value="user" <?php echo e(old('role') === 'user' ? 'selected' : ''); ?>><?php echo e($labels['customer_role'] ?? 'عميل'); ?></option>
                        <option value="vendor" <?php echo e(old('role') === 'vendor' ? 'selected' : ''); ?>><?php echo e($labels['vendor_role'] ?? 'تاجر'); ?></option>
                    </select>
                </div>
            </div>
