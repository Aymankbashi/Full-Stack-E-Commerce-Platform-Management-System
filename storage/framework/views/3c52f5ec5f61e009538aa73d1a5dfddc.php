    ...
    <nav class="navbar navbar-expand-lg navbar-dark sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="<?php echo e(route('home')); ?>">
                <i class="bi bi-shop"></i> <?php echo e($labels['site_title'] ?? 'متجر إلكتروني'); ?>
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('products.index')); ?>">
                            <i class="bi bi-grid"></i> <?php echo e($labels['view_products'] ?? 'المنتجات'); ?>

                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('orders')); ?>">
                            <i class="bi bi-receipt"></i> <?php echo e($labels['my_orders'] ?? 'طلباتي'); ?>
                ...
                <div class="d-flex align-items-center">
                    <div class="dropdown">
                        <button class="btn btn-outline-light dropdown-toggle d-flex align-items-center" type="button" data-bs-toggle="dropdown">
                            ...
                            <div class="user-avatar"><?php echo e(Auth::user()->name[0]); ?></div>
                        </button>
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('user.dashboard')); ?>">
                                    <i class="bi bi-speedometer2"></i> <?php echo e($labels['dashboard'] ?? 'لوحة التحكم'); ?>

                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('wishlist')); ?>">
                                    <i class="bi bi-heart"></i> <?php echo e($labels['wishlist'] ?? 'قائمة الرغبات'); ?>
                            ...
                            <?php if(Auth::user()->isRole('admin')): ?>
                                <li>
                                    <a class="dropdown-item" href="<?php echo e(route('admin.dashboard')); ?>">
                                        <i class="bi bi-gear"></i> <?php echo e($labels['admin_panel'] ?? 'لوحة الإدارة'); ?>
                            ...
                            <li>
                                <form action="<?php echo e(route('logout')); ?>" method="POST" class="d-inline">
                                    ...
                                    <button type="submit" class="dropdown-item">
                                        <i class="bi bi-box-arrow-right"></i> <?php echo e($labels['logout'] ?? 'تسجيل الخروج'); ?>
    ...
    <div class="dashboard-header">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1 class="mb-0">مرحباً، <?php echo e(Auth::user()->name); ?></h1>
...
<?php /**PATH C:\xampp\htdocs\laravel-store-project\resources\views/dashboard.blade.php ENDPATH**/ ?>