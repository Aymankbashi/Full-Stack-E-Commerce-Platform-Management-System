...
<head>
    ...
    <title><?php echo e($labels['blog'] ?? 'المدونة'); ?></title>
...
<body style="direction: <?php echo e($dir); ?>;">
    <div class="container">
        <h2><?php echo e($labels['blog'] ?? 'المدونة'); ?></h2>
        <div class="blog-list">
            <div class="blog-card">
...
<?php /**PATH C:\xampp\htdocs\laravel-store-project\resources\views/blog/index.blade.php ENDPATH**/ ?>