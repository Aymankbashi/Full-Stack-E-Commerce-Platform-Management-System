...
<head>
    ...
    <title><?php echo e($labels['login'] ?? 'تسجيل الدخول'); ?></title>
...
<body>
    <div class="login-container">
        <div class="login-header">
            ...
            <h2><?php echo e($labels['login'] ?? 'تسجيل الدخول'); ?></h2>
        </div>
        ...
        <form method="POST" action="<?php echo e(url('/login')); ?>">
            ...
            <button type="submit" class="btn-login">
                ...
                <?php echo e($labels['login'] ?? 'دخول'); ?>

            </button>
        </form>
        <div class="links">
            <a href="<?php echo e(route('register')); ?>"><?php echo e($labels['register'] ?? 'إنشاء حساب جديد'); ?></a>
            <span style="margin: 0 0.5rem;">|</span>
            <a href="<?php echo e(route('password.request')); ?>"><?php echo e($labels['forgot_password'] ?? 'نسيت كلمة المرور؟'); ?></a>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\laravel-store-project\resources\views/login.blade.php ENDPATH**/ ?>