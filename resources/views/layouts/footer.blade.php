    ...
    <div class="container py-5">
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <h5 class="mb-3">{{ $labels['about'] }}</h5>
                <p class="text-muted">
                    {{ $labels['site_title'] }} - متجرك الإلكتروني المفضل لجميع احتياجاتك.
            ...
            <!-- Quick Links -->
            <div class="col-md-4 mb-4">
                <h5 class="mb-3">{{ $labels['categories'] }}</h5>
            ...
            <!-- Contact Info -->
            <div class="col-md-4 mb-4">
                <h5 class="mb-3">{{ $labels['contact'] }}</h5>
                <ul class="list-unstyled">
                    <li class="mb-2">
        ...
        <div class="row">
            <div class="col-md-6 text-center text-md-start">
                <p class="mb-0 text-muted">
                    &copy; {{ date('Y') }} {{ $labels['site_title'] }}. جميع الحقوق محفوظة.
                </p>
            </div>
