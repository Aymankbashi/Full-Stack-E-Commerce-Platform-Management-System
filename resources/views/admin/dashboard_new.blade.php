    ...
    <div class="main-content">
        <div class="stats-grid">
            ...
            <div id="userStats" style="display: none; grid-column: 1 / -1;">
                ...
                <div class="stat-card">
                    <div class="stat-icon" style="background: linear-gradient(135deg, #fff3e0 0%, #ffe0b2 100%); color: #e65100;">
                        <i class="fas fa-headset"></i>
                    </div>
                    <div class="stat-info">
            ...
            <div class="stat-card" onclick="window.location.href='{{ route('support.agent.dashboard') }}'">
